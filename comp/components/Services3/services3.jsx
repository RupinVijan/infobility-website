      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-md-6 items  md-mb30">
            <div className="item wow fadeIn" data-wow-delay=".3s">
              <span className="icon">
                <i className="ion-ios-bolt-outline color-font"></i>
              </span>
              <h5 className="color-font">Creative Always</h5>
              <p>
                Implementation and rollout of new network infrastructure,
                including consolidation.
              </p>
          ...
          <div className="col-lg-3 col-md-6 items sm-mb30">
            <div className="item wow fadeIn" data-wow-delay=".3s">
              <span className="icon">
                <i className="ion-cube  color-font"></i>
              </span>
              <h5 className="color-font">Real-time Editing</h5>
          ...
          <div className="col-lg-3 col-md-6 items">
            <div className="item wow fadeIn" data-wow-delay=".3s">
              ...
              <h5 className="color-font">Art Concept</h5>
              <p>
                Implementation and rollout of new network infrastructure,
                including consolidation.
              </p>
